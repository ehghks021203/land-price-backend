...
def create_user(connection: object) -> None:
  try:
...
def create_land_info(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_land_report(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_listing(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_trade_history(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_region_coordinate(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_geometry_data(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
...
def create_user_favorite_land(connection: object) -> None:
  try:
    cursor = connection.cursor()
    query = '''
